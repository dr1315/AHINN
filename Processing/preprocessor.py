...
def extract_inputs_and_labels_from_dataframe(dataframe, label='binary_id', include_era=True, qa_filter=True, qa_limit=0.7):
    '''
...
def get_scene_angles(scn):
    ...
    scn_time = (scn.start_time) + (scn.end_time - scn.start_time) / 2  # Set the scene time to be halfway through the scan
